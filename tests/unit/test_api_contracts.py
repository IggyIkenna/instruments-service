...
def test_ccxt_order_validates_with_api_contracts() -> None:
...
def test_thegraph_response_validates_with_api_contracts() -> None:
    """Validate a GraphQL response wrapper with api-contracts schema."""
    from api_contracts.thegraph.schemas import TheGraphResponse
