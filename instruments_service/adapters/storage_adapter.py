...
Thin I/O layer - delegates to unified-cloud-services for GCS operations.
...
class StorageAdapter:
    ...
    def __init__(self, cloud_target: CloudTarget | None = None):
        ...
        logger.info(f"Initialized StorageAdapter: project={cloud_target.project_id}, bucket={cloud_target.gcs_bucket}")
    ...
    def upload_batch(
        ...
        return bucket_cloud_service.upload_to_gcs_batch(batch_uploads, show_progress=False)
