...
class CompoundV3ReferenceDataAdapter(BaseReferenceDataAdapter):
    ...
    def _build_market_records(
        ...
        supply_instrument_key = build_instrument_id(venue_tag, InstrumentType.A_TOKEN, supply_symbol)
        results = [
            InstrumentRecord(
        ...
        borrow_instrument_key = build_instrument_id(venue_tag, InstrumentType.DEBT_TOKEN, borrow_symbol)
        results.append(
            InstrumentRecord(
