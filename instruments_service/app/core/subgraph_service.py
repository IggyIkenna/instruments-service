...
class SubgraphService:
    ...
    def get_subgraph_url(self, protocol: str, chain: str = "ETHEREUM", api_key: Optional[str] = None) -> Optional[str]:
        """
    ...
    def _resolve_via_context7(self, protocol: str, chain: str, api_key: Optional[str] = None) -> Optional[str]:
        """
    ...
    def clear_cache(self, protocol: Optional[str] = None, chain: Optional[str] = None):
        ...
        if protocol and chain:
            ...
            keys_to_remove = [k for k in self._subgraph_cache.keys() if k.startswith(f"{protocol.lower()}_")]
