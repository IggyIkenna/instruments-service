...
def delete_all_tasks(client: ClickUpClient, list_id: str, dry_run: bool = False):
    ...
    active_tasks = client.get_tasks(list_id, archived=False, include_subtasks=True, include_all_statuses=True)
    archived_tasks = client.get_tasks(list_id, archived=True, include_subtasks=True, include_all_statuses=True)
