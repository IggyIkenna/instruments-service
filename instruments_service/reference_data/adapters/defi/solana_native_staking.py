...
# Bug-class-3 sweep 2026-08-04: replaced hardcoded date with UAC call.
_SOLANA_GENESIS_DATE: datetime = datetime.fromisoformat(cast(str, get_chain_genesis_date(_DEFAULT_CHAIN))).replace(
    tzinfo=UTC
)
