...
class AaveV3Adapter:
    ...
    def __init__(self, chain: str = 'ETHEREUM', api_key: Optional[str] = None, project_id: Optional[str] = None):
        """
        ...
        self.base_url = 'https://api.aavescan.com' if self.chain == 'ETHEREUM' else f'https://{chain.lower()}.aavescan.com'
    ...
    def _create_a_token_instrument(self, reserve: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
    ...
    def _create_debt_token_instrument(self, reserve: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
