...
correctly defined across all sources:
- unified_api_contracts (TRADFI_VENUE_MAPPINGS, DATABENTO_VALID_PARENT_SYMBOLS, EXCHANGE_CODE_TO_NAME)
...
class TestLivestockFuturesDefinitions:
    ...
    def test_le_in_exchange_mappings(self) -> None:
        ...
        from unified_api_contracts import EXCHANGE_CODE_TO_NAME
...
class TestCrossRegistryConsistency:
    ...
    def test_all_futures_options_codes_in_exchange_mappings(self) -> None:
        ...
        from unified_api_contracts import EXCHANGE_CODE_TO_NAME, TRADFI_VENUE_MAPPINGS
    ...
    def test_livestock_vx_in_instrument_definitions(self) -> None:
        """LE, HE, VX must also be in UAC TRADFI_VENUE_MAPPINGS."""
        from unified_api_contracts import TRADFI_VENUE_MAPPINGS
