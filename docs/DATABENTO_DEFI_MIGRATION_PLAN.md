...
BASIS_DOWNLOADERS__ALCHEMY_API_KEY=***REDACTED-ALCHEMY-KEY***
BASIS_DOWNLOADERS__ALCHEMY_API_KEY_2=***REDACTED-ALCHEMY-KEY***

# AaveScan (for AAVE data)
BASIS_DOWNLOADERS__AAVESCAN_API_KEY=***REDACTED-AAVESCAN-KEY***

# Databento (from archive code)
# API Key: ***REDACTED-DATABENTO-KEY***
```
