...
class TestAaveV3Adapter:
    ...
    def test_fetch_markets_with_reserves(self):
        ...
        with patch("instruments_service.app.venues.defi.aave_adapter.BaseDefiAdapter.__init__", return_value=None):
            ...
            adapter._create_a_token_instrument = Mock(return_value={"instrument_key": "AAVE_V3_ETH:A_TOKEN:WETH@ETHEREUM"})
            adapter._create_debt_token_instrument = Mock(return_value={"instrument_key": "AAVE_V3_ETH:DEBT_TOKEN:DEBTWETH@ETHEREUM"})
