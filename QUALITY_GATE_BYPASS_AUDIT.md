...
| **func/method size**         | `cli/parser.py` (235L argparse), `utils/ccxt_service.py` (per-venue loops 123L×2), `cli/handlers/live_mode_handler.py` (orchestration 96L), `cli/handlers/corporate_actions_update_handler.py` (pipeline 96L) | Declarative argparse, per-venue CCXT extraction branches, live orchestration setup. Refactoring adds indirection without reducing complexity. Reviewed 2026-03-18.                |
| **imports inside functions** | `engine/venues/ccxt_service.py` (TYPE_CHECKING), `cli/parser.py` (epilog help text)                                                                                                                           | TYPE_CHECKING lazy imports for type hints only, not runtime.                                                                                                                      |
