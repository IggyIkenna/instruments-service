...
class TestVenueMappingExtended:
    ...
    def test_all_tardis_exchanges_complete(self):
        ...
        expected_exchanges = ['binance', 'binance-futures', 'deribit', 'bybit', 'bybit-spot', 'okex', 'okex-futures', 'okex-swap']
...
class TestDataTypeConfigExtended:
    ...
    def test_default_data_types(self):
        ...
        expected_defaults = ['trades', 'book_snapshot_5', 'derivative_ticker', 'liquidations', 'options_chain']
