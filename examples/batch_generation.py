...
from instruments_service import InstrumentProcessingService, CloudInstrumentStorage, InstrumentBatchProcessor
...
def main():
    ...
    # Run async function
    result = asyncio.run(generate_instruments_batch(
