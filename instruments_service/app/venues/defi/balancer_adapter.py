...
class BalancerAdapter(BaseDefiAdapter):
    ...
    def __init__(
        ...
        self.graph_client = TheGraphClient(subgraph_url, api_key=None, project_id=project_id)  # Balancer API doesn't need API key
            ...
            try:
                ...
                if allowed_quotes:
                    ...
                    if base_currency:
                        ...
                        quote_candidates = [sym for sym in token_symbols if sym != base_upper and sym in allowed_quotes]
    ...
    def fetch_spot_pairs(
        ...
        **kwargs
        ...
        Returns:
            Dictionary mapping instrument_key to instrument definition
        """
        pools = self.fetch_pools(base_currency=base_currency, quote_currency_list=quote_currency_list, **kwargs)
