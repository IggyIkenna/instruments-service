...
class RaydiumReferenceDataAdapter(BaseReferenceDataAdapter):
    ...
    def _build_historical_pool_record(
        ...
        # reproduces it verbatim; the literal :POOL: segment matches the sanctioned glued_pair_id
        # convention used by build_pool_identity() below for the same SOLANA_AMM_POOL type).
        instrument_key = build_instrument_id(venue_tag, InstrumentType.POOL, f"{pool_id}-Historical")
