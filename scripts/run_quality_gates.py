...
def run_tests_with_coverage(coverage_threshold: int = 75) -> dict:
    ...
    print(f"Coverage: {coverage_percent:.2f}% {'✅' if coverage_meets_threshold else '❌'} (threshold: {coverage_threshold}%)")
    print("=" * 70)
...
def main():
    ...
    parser.add_argument('--coverage-threshold', type=int, default=75, help='Minimum coverage percentage (default: 75)')
