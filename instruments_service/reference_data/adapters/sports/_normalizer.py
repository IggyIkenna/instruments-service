"""
Sports normalizer helpers for URDI sports adapters.

TeamNormalizer maps team name variants to canonical identifiers.
Moved from instruments-service/sports/team_normalizer.py to URDI per
refactor plan (sports normalization belongs in the reference data adapter layer).
