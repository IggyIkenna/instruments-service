...
class TestCredentialLoading:
    ...
    def test_tardis_api_key_loading(self):
        ...
        with patch("unified_cloud_services.get_secret_with_fallback", return_value="test-tardis-key"):
    ...
    def test_tardis_api_key_from_env(self):
        ...
        with patch("unified_cloud_services.get_secret_with_fallback", return_value="env-tardis-key"):
            service = InstrumentProcessingService(config)
    ...
    def test_databento_api_key_loading(self):
        ...
        try:
            ...
            with patch("instruments_service.app.venues.databento.databento_adapter.db", mock_db_module), \
                 patch("unified_cloud_services.get_secret_with_fallback", return_value="test-databento-key"):
    ...
    def test_databento_api_key_from_env(self):
        ...
        try:
            ...
            with patch("instruments_service.app.venues.databento.databento_adapter.db", mock_db_module), \
                 patch("unified_cloud_services.get_secret_with_fallback", return_value="env-databento-key"):
                databento_adapter.db = mock_db_module
                databento_adapter.DATABENTO_AVAILABLE = True
    ...
    def test_the_graph_api_key_loading(self):
        ...
        try:
            ...
            with patch("unified_cloud_services.get_secret_with_fallback", return_value="test-graph-key"):
    ...
    def test_the_graph_api_key_from_env(self):
        ...
        try:
            ...
            with patch("unified_cloud_services.get_secret_with_fallback", return_value="env-graph-key"):
                client = TheGraphClient(subgraph_url="https://test.com")
                # The key gets stripped, so we check it equals the expected value
    ...
    def test_alchemy_api_key_loading(self):
        ...
        with patch("instruments_service.app.venues.defi.aave_adapter.BaseDefiAdapter.__init__", return_value=None), \
             patch("unified_cloud_services.get_secret_with_fallback", return_value="test-alchemy-key"):
            ...
            with patch("unified_cloud_services.get_secret_with_fallback", return_value="test-alchemy-key"):
    ...
    def test_aavescan_api_key_loading(self):
        ...
        with patch("instruments_service.app.venues.defi.aave_adapter.BaseDefiAdapter.__init__", return_value=None), \
             patch("unified_cloud_services.get_secret_with_fallback", return_value="test-aavescan-key"):
            adapter = AaveV3Adapter.__new__(AaveV3Adapter)
            adapter.chain = "ETHEREUM"
            adapter.project_id = "test-project"
            adapter.venue = "AAVE_V3_ETH"
    ...
    def test_all_credentials_priority_order(self):
        ...
        with patch("unified_cloud_services.get_secret_with_fallback", return_value="secret-key"), \
    ...
    def test_credentials_fallback_chain(self):
        ...
        with patch("unified_cloud_services.get_secret_with_fallback", return_value="env-fallback-key"):
            service = InstrumentProcessingService(config)
