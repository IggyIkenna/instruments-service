...
class TardisIntegrationMixin:
    ...
    async def fetch_exchange_instruments(
        ...
        logger.info(f"✅ Retrieved {len(instruments_data)} instruments for {exchange}")
...
class DefiIntegrationMixin:
    ...
    def __init_defi_integration(self):
...
class CCXTIntegrationMixin:
    ...
    def __init_ccxt_integration(self, config: dict[str, Any]):
...
class SymbolProcessingMixin:
    ...
    def __init_symbol_processing(self):
