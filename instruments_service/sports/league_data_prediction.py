"""
League Data — Prediction-tier football leagues.

Contains all Prediction-classified leagues from the league registry.
These are the top-tier domestic leagues with full or near-full data-source
coverage, suitable for model-based predictions.
"""

from __future__ import annotations

from instruments_service.sports.league_definition import (
    PRED_FULL,
    PRED_NO_FOOTYSTATS,
    PRED_NO_UNDERSTAT,
    LeagueDefinition,
...
# ---------------------------------------------------------------------------
# PREDICTION LEAGUES — top-tier domestic football leagues
# ---------------------------------------------------------------------------

PREDICTION_LEAGUES: dict[str, LeagueDefinition] = {
    # ===================================================================
    # PREDICTION LEAGUES — ENGLAND
    # ===================================================================
    ...
    # ===================================================================
    # PREDICTION LEAGUES — NETHERLANDS
    # ===================================================================
    ...
    # ===================================================================
    # PREDICTION LEAGUES — SWITZERLAND
    # ===================================================================
    ...
    # ===================================================================
    # PREDICTION LEAGUES — USA (FOOTBALL/SOCCER)
    # ===================================================================
    ...
    # ===================================================================
    # PREDICTION LEAGUES — SOUTH KOREA
    # ===================================================================
