"""
Special instrument definitions - KRW/USD, Bitcoin ETFs.

Extracted from DatabentoAdapter.create_krwusd_instrument_definition and
...
def create_krwusd_instrument_definition(
    ...
    """
    _ = target_date  # Unused - forex has no expiry
    venue = "FX"
