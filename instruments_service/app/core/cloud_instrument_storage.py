...
class CloudInstrumentStorage:
    ...
    def __init__(self, cloud_target: CloudTarget = None):
        ...
        if cloud_target is None:
            ...
            is_test = (
                environment in ['test', 'testing'] or  # Explicit test environment
            ...
            cloud_target = CloudTarget(
                ...
                bigquery_location=os.getenv('BIGQUERY_LOCATION', 'asia-northeast1')  # Default to asia-northeast1 per .env
            )
    ...
    def store_instruments(
        ...
        try:
            ...
            try:
                ...
                required_columns = ['instrument_key', 'venue', 'instrument_type', 'available_from_datetime']
            ...
            timestamp_columns = ['timestamp', 'available_from_datetime', 'available_to_datetime', 'expiry']
