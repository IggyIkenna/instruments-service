...
# footystats-served data_types (``PREDICTIONS`` / ``MATCHES``) are stamped with
# ``BATCH_FOOTYSTATS``. ODDS removed 2026-06-25 (#6 coherent unit) — bookmaker
# odds are MTDS/odds-api owned.
